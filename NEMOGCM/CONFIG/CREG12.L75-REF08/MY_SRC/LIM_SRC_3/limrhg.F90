...
!CT start output fields {
      ! --- SIMIP --- !
      CALL lbc_lnk_multi( zfU, 'U', -1.,   zfV, 'V', -1. )

      CALL iom_put( "intstrx" , zfU )   ! Internal force term in force balance (x)
      CALL iom_put( "intstry" , zfV )   ! Internal force term in force balance (y)
!CT start output fields }
