...
!}
      ...
      TYPE(OBC_DATA), POINTER                ::   dta           ! short cut
#if defined key_lim3
!CT this change has been done in the trunk
      INTEGER, DIMENSION(4) ::   zdimsz   ! 4 dimensions (i.e. i,j,t,ice-cat) when using MJMgd16 BDY data based on LIM 3
!CT      INTEGER, DIMENSION(3) ::   zdimsz   ! 3 dimensions (i.e. i,j,t)  when using either seasonal cycle or GLORYS BDY data  based on LIM 2
!CT this change has been done in the trunk
