...
!CT                  en(ji,jj,jk) = en(ji,jj,jk) + rdt * ( 1._wp - fr_i(ji,jj) ) * ( zwlc * zwlc * zwlc ) /   &
!CT                  en(ji,jj,jk) = en(ji,jj,jk) + rdt * ( MAX(0.,1._wp - 4.*fr_i(ji,jj) ) ) * ( zwlc * zwlc * zwlc ) /   &
...
!CT                     &                                 * ( MAX(0.,1._wp - 4.*fr_i(ji,jj) ) )  * wmask(ji,jj,jk) * tmask(ji,jj,1)
